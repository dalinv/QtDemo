...
namespace libxl
{
    enum Color
    {
        ...
        COLOR_INDIGO,
        COLOR_GRAY80,
        COLOR_DEFAULT_FOREGROUND = 0x0040,
        COLOR_DEFAULT_BACKGROUND = 0x0041,
        COLOR_TOOLTIP = 0x0051,
        COLOR_NONE = 0x7F,
        COLOR_AUTO = 0x7FFF
    };
    ...
    enum Underline
    {
        ...
        UNDERLINE_SINGLE,
        UNDERLINE_DOUBLE,
        UNDERLINE_SINGLEACC = 0x21,
        UNDERLINE_DOUBLEACC = 0x22
    };
    ...
    {
        ERRORTYPE_NULL = 0x00,
        ERRORTYPE_DIV_0 = 0x07,
        ERRORTYPE_VALUE = 0x0F,
        ERRORTYPE_REF = 0x17,
        ERRORTYPE_NAME = 0x1D,
        ERRORTYPE_NUM = 0x24,
        ERRORTYPE_NA = 0x2A,
        ERRORTYPE_NOERROR = 0xFF
    };
