...
namespace libxl
{
    template <class TCHAR> struct IFilterColumnT
    {
        ...
        virtual void XLAPIENTRY setTop10(
            double value, bool top = true, bool percent = false) = 0;

        virtual bool XLAPIENTRY getCustomFilter(Operator *op1, const TCHAR **v1,
            Operator *op2, const TCHAR **v2, bool *andOp) const = 0;
        virtual void XLAPIENTRY setCustomFilter(Operator op1, const TCHAR *v1,
            Operator op2 = OPERATOR_EQUAL, const TCHAR *v2 = 0, bool andOp = false) = 0;
